...
See the official [announcement post](/blog/lytenyte-version-2.1) for in depth details of the changes.

- Cell Range Selection is now a Core feature that is available for free. No changes required for PRO.
- Expressions Feature added to PRO. Expressions provide a dynamic DSL creation function. See the new
  [expressions guides](/docs/expressions-overview) for more details.
- Comprehensive AI skills support added for LyteNyte Grid. See the [AI enhanced workflows guides](/docs/ai-skills-installation)
  for more details.
