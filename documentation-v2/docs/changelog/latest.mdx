...
- `requestForGroup`: Returns the [DataRequest](/docs/reference) for a given group row.
- `requestForNextSlice`: Returns the [DataRequest](/docs/reference) for the next slice to aid optimistic data fetching.
- `requestsForView`: Returns the [DataRequests](/docs/reference) for the current view.
...
- Pivot-related properties refactored. `columnPivotModel` now holds the complete pivot configuration. See the [column pivoting guide](/docs/reference).
