...
- `requestForGroup`: Returns the [DataRequest](/docs/reference/row-data-source#datarequest) for a given group row.
- `requestForNextSlice`: Returns the [DataRequest](/docs/reference/row-data-source#datarequest) for the next slice to aid optimistic data fetching.
- `requestsForView`: Returns the [DataRequests](/docs/reference/row-data-source#datarequest) for the current view.
