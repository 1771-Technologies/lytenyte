...
LyteNyte Grid accepts state via props provided to the `Grid` component.
...
- [Row & Column Virtualization](/docs/grid-virtualization): Learn how LyteNyte Grid enables performance at scale with row and column virtualization.
