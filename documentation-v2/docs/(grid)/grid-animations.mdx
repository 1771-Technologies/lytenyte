...
step: Learn how to animate rows and columns within the grid.
---

## Animations Overview

LyteNyte Grid can animate rows and columns when they are added, removed, or
reordered. Animations use the [Web Animations API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Animations_API)
and run outside the React render cycle, so they do not affect grid rendering performance.
