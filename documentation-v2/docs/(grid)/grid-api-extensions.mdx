...
description: Extend the LyteNyte Grid API with additional properties for each grid instance.
  Use these properties to share custom functionality across renderers provided to the grid.
---
...
The function form of the `apiExtension` is useful when the methods you add to the API need to call the grid API to perform work.
