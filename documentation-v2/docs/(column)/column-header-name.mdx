...
To support editing header names, this example uses a custom header cell
and extends the grid API to enable it. For more guidance on extending
the grid API, see the [API Extension guide](/docs/grid-api-extensions).
