...
export default function ColumnBase() {
  ...
  return (
    <div
      className="ln-grid ln-cell:text-xs ln-header:text-xs ln-header:text-ln-text-xlight ln-header-group:text-center"
      style={{ height: 500 }}
    >
      <Grid
        columns={columns}
        ...
        slotShadows={() => <ViewportShadows start top={false} />}
      />
    </div>
  );
}
