...
const initialColumns: Grid.Column<GridSpec>[] = [
  { id: "symbol", field: "symbol", cellRenderer: SymbolCell, width: 250, name: "Symbol" }, //!
  { id: "network", field: "network", cellRenderer: NetworkCell, width: 220, name: "Network" }, //!
  { id: "exchange", field: "exchange", cellRenderer: ExchangeCell, width: 220, name: "Exchange" },
  ...
  { id: "volatility", field: "volatility", cellRenderer: PercentCell, name: "Volatility", type: "number" },
  {
    id: "volatility1m",
    field: "volatility1m",
  ...
  return (
    <>
      <div
        ...
        style={{ height: 500 }}
      >
        <Grid columns={initialColumns} columnBase={base} rowSource={ds} />
      </div>
    </>
  );
}
