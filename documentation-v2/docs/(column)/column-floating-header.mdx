...
See the [Grid View API reference](/docs/reference/grid-view#headercellfloating) for more details.
...
- [Column Moving](/docs/column-moving): Reorder columns programmatically or via drag-and-drop.
- [Column Base](/docs/column-base): See the default column values and how to override them with the `columnBase` property.
- [Column Header Height](/docs/column-header-height): Adjust the height of the header row, group header rows, or the floating header row.
