...
- [`Grid.GridSpec`](/docs/reference): A generic type constraint used by other LyteNyte Grid interfaces.
...
- [`Grid.API`](/docs/reference): The base interface that describes the LyteNyte Grid API.
...
### Specification Parameters & Properties

The grid specification includes four optional properties:
...
The four optional type parameters are as follows:
...
### Combining Specification Types & Properties
