...
behavior programmatically with the [`api.rowSelect`](/docs/reference) method, as shown below:
...
In most cases, it is sufficient to call the [`rowsSelected`](/docs/reference)
