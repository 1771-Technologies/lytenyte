...
pro: true
step: Explains server-side sorting and how it is displayed client-side.
...
The LyteNyte Grid [state object](/docs/grid-reactivity) maintains a [sort model](/docs/reference),
