...
- `requestsForView`: a reactive value that returns [Data Request Objects](/docs/reference) for the current view.
- `pushRequests`: sends [Data Request Objects](/docs/reference) to the
