...
- [Quick Search](/docs/reference): A string-based search that matches a value across any cell in a row.
...
[`DataInFilterItemFetcherParams`](/docs/reference) interface:
...
The fetcher should return an array (or `Promise`) of [`FilterInFilterItem`](/docs/reference) objects:
...
The example below uses LyteNyte Grid's [Filter Tree](/docs/component-tree-view)
