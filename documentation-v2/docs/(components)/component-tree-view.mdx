...
description: Use the Tree View component to render hierarchical data in an expandable and collapsible list.
---

LyteNyte Grid exports a `TreeView` component for tree-based UIs,
such as [tree set filters](/docs/filtering-set-filters). `TreeView` is a specialized,
...
LyteNyte Grid variant, it requires a [sized container](/docs/grid-container).

::demo[Tree View Implementation="./demos/tree-view-demo"]
...
::demo[Tree Selection Implementation="./demos/tree-view-selection"]
...
::demo[Custom Tree View Nodes="./demos/tree-view-children"]
