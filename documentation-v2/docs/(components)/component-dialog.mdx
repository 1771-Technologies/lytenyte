...
title: Dialog
pro: true
step: Present critical information or request decisions in a focused modal.
description: Use a dialog to present important information, prompt decisions, or collect input in a modal overlay.
---

A dialog is a transient UI overlay that appears above the main content,
temporarily interrupting the user's workflow to convey critical information,
prompt a decision, or request input.
...
The demo below demonstrates a basic dialog. It contains the minimum structure required for
a fully accessible dialog, which you can expand upon to meet your application's needs.

::demo[Basic Dialog Implementation="./demos/dialog-demo"]

## Dialog Properties

Dialog elements accept standard HTML props. Some parts also
support additional properties, which are documented below.
