...
pro: true
step: Handle row group expansion and collapsing with the row group component.
...
The `RowGroupCell` component extends [`CellParamsWithIndex`](/docs/reference). The properties
