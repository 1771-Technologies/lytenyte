...
title: Menu Button
pro: true
step: Show a list of actions in a dropdown with full keyboard accessibility.
description: A menu button displays a list of actions when the user presses the button.
---
...
::demo[Submenu="./demos/menu-submenu-demo"]
...
The `Menu` component is a popover component with additional logic for handling dropdown
menus. Its properties reflect this.
