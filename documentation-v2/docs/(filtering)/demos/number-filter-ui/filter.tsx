        ...
        <>
          ...
          <SmartSelect
            ...
            onOptionChange={(option) => {
              ...
              setFilter((prev) => {
                if (!prev) return { right: { operator: option.id as FilterNumberOperator } };
                return { ...prev, right: { ...prev.right, operator: option.id as FilterNumberOperator } };
              });
            }}
            kind="basic"
            trigger={
          ...
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => {
                  setFilter((prev) => {
                    if (!prev) return { right: { value: Number.parseFloat(e.target.value) } };

                    return { ...prev, right: { ...prev.right, value: Number.parseFloat(e.target.value) } };
                  });
                }}
              />
            </label>
