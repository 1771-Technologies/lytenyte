...
LyteNyte Grid Skills provide coding agents with detailed, up-to-date context
...
This will install the LyteNyte Skills into the skills folder for your current AI agents.
The exact folder depends on the AI agent you are using. See the [Support Agents](https://github.com/vercel-labs/skills?tab=readme-ov-file#supported-agents)
section of the Skills CLI for more details.
