...
step: Learn how to install and update LyteNyte Grid AI Skills.
description: Install LyteNyte Grid AI Skills with the Vercel Skills CLI.
---

:::info
If you're unfamiliar with AI Skills, see the [AI Skills Overview guide](/docs/ai-skills-overview).
::::
