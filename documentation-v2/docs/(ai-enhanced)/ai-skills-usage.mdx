...
Once installed, your coding agents automatically use the LyteNyte Grid Skill.
...
- **Reference Files:** The agent loads files on demand. It reads only the files relevant to the current task, keeping context usage efficient.
...
The coding agent knows which features are part of the PRO edition of LyteNyte Grid. If you ask about
a PRO feature without specifying your edition, the coding agent checks automatically. You do not need a
PRO license to start building. The grid is fully functional without a key and simply displays
a watermark until you activate a license.
