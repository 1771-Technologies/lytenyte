...
<AutoTypeTable path="../packages/commercial-lytenyte-pro/src/+types.ts" name="GridState" />
...
<AutoTypeTable path="../packages/commercial-lytenyte-pro/src/+types.ts" name="UseLyteNyteProps" />
