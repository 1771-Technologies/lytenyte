...
<AutoTypeTable path="../packages/commercial-lytenyte-pro/src/+types.ts" name="DialogFrame" />
...
<AutoTypeTable path="../packages/commercial-lytenyte-pro/src/+types.ts" name="DialogFrameRendererParams" />
...
<AutoTypeTable path="../packages/commercial-lytenyte-pro/src/+types.ts" name="PopoverFrame" />
...
<AutoTypeTable path="../packages/commercial-lytenyte-pro/src/+types.ts" name="PopoverFrameRendererParams" />
...
<AutoTypeTable path="../packages/commercial-lytenyte-pro/src/+types.ts" name="VirtualTarget" />
