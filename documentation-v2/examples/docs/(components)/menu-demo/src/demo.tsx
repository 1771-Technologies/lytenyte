...
const menuClass = "grid grid-cols-[24px_1fr] gap-2 ps-[4px]";
const radioClass = "grid grid-cols-[24px_1fr]";
      ...
      <Menu>
        ...
        <Menu.Popover>
          ...
          <Menu.Container>
            ...
            <Menu.Divider />
            <Menu.Header className="px-2 py-1 text-xs font-medium">Row Height</Menu.Header>
