...
test("applyClearBodyScroll (iOS): clears touch handlers and resets listener", () => {
...
test("applyClearBodyScroll (non-iOS): calls applyRestoreOverflow only", () => {
...
test("applyClearBodyScroll: always clears locks and locksIndex", () => {
  (isIOS as any).mockReturnValue(false);
