...
describe("isNodeAttached", () => {
  ...
  // Attached shadow DOM
  test("returns true for node in attached shadow DOM", () => {
  ...
  // Detached shadow DOM
  test("returns false for node in detached shadow DOM", () => {
    const host = document.createElement("div");
    const shadow = host.attachShadow({ mode: "open" });
    const child = document.createElement("span");
    shadow.appendChild(child);
  ...
  test("returns true for node in nested attached shadow DOM", () => {
  ...
  test("returns false for node in nested detached shadow DOM", () => {
    const outerHost = document.createElement("div");
