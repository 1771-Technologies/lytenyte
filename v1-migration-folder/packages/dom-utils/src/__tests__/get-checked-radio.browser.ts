...
test("getCheckedRadio: checked radio", async () => {
  const form = html`
    <form>
...
test("getCheckedRadio: should return undefined when there are no checked radios", () => {
  const form = html`
    <form>
      <input type="radio" id="html" name="fav_language" value="HTML" />
      <label for="html">HTML</label><br />
...
test("getCheckedRadio: should return undefined when the check input does not belong to the correct form", () => {
  const form = html`
    <form>
      <input type="radio" id="html" name="fav_language" value="HTML" />
      <label for="html">HTML</label><br />
