...
describe("sortByOrder", () => {
  test("returns single regular tabbable element", () => {
  ...
  test("sorts elements with positive tabIndex before regular tabbables", () => {
  ...
  test("sorts based on tabIndex and document order", () => {
  ...
  test("recursively sorts and flattens CandidateScope", () => {
    const el1 = document.createElement("button");
    const el2 = document.createElement("button");
  ...
  test("sorts scope parent by tabIndex and flattens contents", () => {
    const el1 = document.createElement("button");
    const el2 = document.createElement("button");
  ...
  test("mixes ordered and regular elements correctly", () => {
    const el1 = document.createElement("button");
    const el2 = document.createElement("button");
