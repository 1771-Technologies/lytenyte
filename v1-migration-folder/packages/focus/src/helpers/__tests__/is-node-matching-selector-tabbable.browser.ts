...
describe("isNodeMatchingSelectorTabbable", () => {
  test("returns false if node is a non-tabbable radio", () => {
  ...
  test("returns false if tabIndex < 0", () => {
    const node = document.createElement("input");
  ...
  test("returns false if node is not focusable", () => {
    const node = document.createElement("input");
  ...
  test("returns true if all conditions pass", () => {
    const node = document.createElement("input");
