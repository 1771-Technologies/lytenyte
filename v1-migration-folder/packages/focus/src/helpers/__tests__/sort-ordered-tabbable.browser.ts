...
describe("sortOrderedTabbables", () => {
  test("sorts by tabIndex when tabIndex values differ", () => {
  ...
  test("sorts by documentOrder when tabIndex values are equal", () => {
  ...
  test("returns 0 if both tabIndex and documentOrder are equal", () => {
