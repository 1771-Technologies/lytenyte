...
test("distance: returns 0 when both points are the same", () => {
  expect(distance(0, 0, 0, 0)).toBe(0);
  expect(distance(5, 5, 5, 5)).toBe(0);
});

test("distance: returns correct value for horizontal distance", () => {
  expect(distance(0, 0, 3, 0)).toBe(3);
  expect(distance(10, 0, 4, 0)).toBe(6);
});

test("distance: returns correct value for vertical distance", () => {
  expect(distance(0, 0, 0, 5)).toBe(5);
  expect(distance(2, 10, 2, 4)).toBe(6);
});

test("distance: returns correct diagonal distance", () => {
