...
test("isFunction: returns true for regular functions", () => {
  function fn() {}
  const arrow = () => {};
...
test("isFunction: returns true for async and generator functions", () => {
...
test("isFunction: returns true for built-in functions", () => {
...
test("isFunction: returns false for class instances and constructors", () => {
  class MyClass {}
