...
import { rangedBinarySearch } from "../../virtual-bounds/ranged-binary-search.js";

test("rangedBinarySearch: should return the correct values", () => {
  ...
  expect(rangedBinarySearch(range, 27)).toEqual(1);
