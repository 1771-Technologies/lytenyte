...
describe("computePathTree", () => {
  test("should create the correct basic tree", () => {
    const paths = [
      { id: "x", groupPath: ["A", "B"] },
      { id: "y" },
  ...
  test("should handle adjacent paths of varying levels", () => {
    const paths = [
      { id: "x", groupPath: ["A", "B"] },
  ...
  test("should handle a completely flat tree", () => {
  ...
  test("should handle non-distinct paths", () => {
    const paths = [
      { id: "x", groupPath: ["A", "B"] },
      { id: "t", groupPath: ["A", "B", "C"] },
      { id: "b", groupPath: ["A", "B"] },
