...
function Component({ data = bankData }: { data?: any[] }) {
  ...
  return (
    <div>
      ...
      <div>
        <button onClick={() => g.state.rowHeight.set(() => (i: number) => [20, 40, 60][i % 3])}>
          Row Height Variable
        </button>
        <button onClick={() => g.state.rowHeight.set(40)}>Row Height Fixed</button>
...
export const RowHeights: StoryObj = {
  render: Component,
};
