...
function ViewportImpl({ children, ...props }: JSX.IntrinsicElements["div"], ref: JSX.IntrinsicElements["div"]["ref"]) {
  const [vp, setVp] = useState<HTMLDivElement | null>(null);

  const { setViewport, focusActive, source, rtl, id, api, view } = useRoot();
