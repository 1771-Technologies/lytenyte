...
import type { LayoutHeaderFloating, LayoutHeaderCell } from "../../layout.js";

export interface HeaderCellProps<T> {
  readonly cell: LayoutHeaderCell<T> | LayoutHeaderFloating<T>;
}

const HeaderCellImpl = forwardRef<HTMLDivElement, JSX.IntrinsicElements["div"] & HeaderCellProps<any>>(
