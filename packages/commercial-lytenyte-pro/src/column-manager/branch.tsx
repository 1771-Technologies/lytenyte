...
import { dragState, DropWrap, type SlotComponent } from "@1771technologies/lytenyte-core/yinternal";
...
export const Branch = forwardRef<HTMLLIElement, ColumnManagerBranchProps & JSX.IntrinsicElements["li"]>(
