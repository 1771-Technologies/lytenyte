...
const columns: Grid.Column<Spec>[] = [
  { id: "age", groupPath: ["Alpha"] },
  { id: "job", groupPath: ["Alpha", "Beta"] },
  { id: "balance" },
  { id: "education" },
  { id: "marital", groupPath: ["Delta", "Sigma"] },
  { id: "default", groupPath: ["Delta", "Sigma", "Beta"] },
  { id: "housing", groupPath: ["Delta", "Sigma", "Zeta"] },
  { id: "loan" },
  { id: "contact" },
  { id: "day" },
  { id: "month" },
