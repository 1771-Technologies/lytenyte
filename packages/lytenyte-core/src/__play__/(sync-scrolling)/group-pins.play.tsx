...
const columns: Grid.Column<Spec>[] = [
  { id: "age", groupPath: ["Alpha"], pin: "start", width: 120 },
  { id: "job", groupPath: ["Alpha", "Beta"], pin: "start" },
  { id: "balance", groupPath: ["Alpha"] },
  { id: "education" },
  { id: "marital", pin: "end" },
  { id: "default", pin: "end", width: 110 },
  { id: "housing", groupPath: ["Alpha", "Beta"] },
  { id: "loan", groupPath: ["Alpha", "Beta", "Sigma"] },
  { id: "contact" },
  { id: "day" },
  { id: "month" },
  { id: "duration" },
