...
describe("nearestFocusable", () => {
  ...
  test("Should return the correct focusable detail", () => {
  ...
  test("Should return the correct focusable floating", () => {
  ...
  test("Should return the correct focusable header", () => {
  ...
  test("Should return the correct focusable header group", () => {
