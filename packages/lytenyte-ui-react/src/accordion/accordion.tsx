...
export namespace Accordion {
  ...
  export type Props<T = any> = Omit<JSX.IntrinsicElements["div"], "className" | "style"> & {
     ...
     */
    readonly onValueChange?: (change: T[]) => void;
  };

  export namespace Item {
    export interface State extends Accordion.State {
    ...
    export type Props<T = any> = Omit<JSX.IntrinsicElements["div"], "className" | "style"> & {
      ...
      /**
       * Whether the accordion item can be collapsed and expanded. Overrides the default
       * root value.
       */
      readonly collapsible?: boolean;
       ...
       * Provides the final open state as a boolean.
       */
  ...
  export namespace Header {
    export type Props = JSX.IntrinsicElements["h3"] & {
       ...
       * @default <h3 />
       */
      readonly render?: SlotComponent<Item.State>;
    };
  }
