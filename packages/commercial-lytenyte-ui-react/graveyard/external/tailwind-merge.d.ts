 ...
 */
interface Config<ClassGroupIds$1 extends string, ThemeGroupIds$1 extends string>
  extends ConfigStaticPart,
    ConfigGroupsPart<ClassGroupIds$1, ThemeGroupIds$1> {}
/**
...
interface ConfigGroupsPart<
  ClassGroupIds$1 extends string,
  ThemeGroupIds$1 extends string
> {
  /**
   ...
   */
  theme: NoInfer<ThemeObject<ThemeGroupIds$1>>;
  /**
   ...
   * }
   */
  classGroups: NoInfer<Record<ClassGroupIds$1, ClassGroup<ThemeGroupIds$1>>>;
  /**
  ...
  conflictingClassGroups: NoInfer<
    Partial<Record<ClassGroupIds$1, readonly ClassGroupIds$1[]>>
  >;
  /**
...
> extends Partial<ConfigStaticPart> {
  override?: PartialPartial<ConfigGroupsPart<ClassGroupIds$1, ThemeGroupIds$1>>;
  extend?: PartialPartial<ConfigGroupsPart<ClassGroupIds$1, ThemeGroupIds$1>>;
}
type PartialPartial<T> = {
  [P in keyof T]?: T[P] extends any[] ? T[P] : Partial<T[P]>;
};
type ThemeObject<ThemeGroupIds$1 extends string> = Record<
  ThemeGroupIds$1,
  ClassGroup<ThemeGroupIds$1>
>;
type ClassGroup<ThemeGroupIds$1 extends string> =
  readonly ClassDefinition<ThemeGroupIds$1>[];
type ClassDefinition<ThemeGroupIds$1 extends string> =
  | string
  | ClassValidator
  | ThemeGetter
  | ClassObject<ThemeGroupIds$1>;
...
type ClassObject<ThemeGroupIds$1 extends string> = Record<
  string,
  readonly ClassDefinition<ThemeGroupIds$1>[]
>;
/**
...
declare const getDefaultConfig: () => {
  ...
  readonly classGroups: {
     ...
     * @see https://tailwindcss.com/docs/font-variant-numeric
     */
    readonly "fvn-fraction": readonly [
      "diagonal-fractions",
      "stacked-fractions"
    ];
    /**
     ...
     */
    readonly "text-decoration": readonly [
      "underline",
      "overline",
      "line-through",
      "no-underline"
     ...
     */
    readonly "text-transform": readonly [
      "uppercase",
      "lowercase",
      "capitalize",
      "normal-case"
     ...
     */
    readonly "text-overflow": readonly [
      "truncate",
      "text-ellipsis",
      "text-clip"
    ];
    ...
    readonly "bg-image": readonly [
      {
        readonly bg: readonly [
          "none",
          {
            ...
            readonly radial: readonly [
              "",
              (value: string) => boolean,
              (value: string) => boolean
            ];
            readonly conic: readonly [
              (value: string) => boolean,
              (value: string) => boolean,
              (value: string) => boolean
            ];
  ...
  readonly conflictingClassGroups: {
    ...
    readonly "translate-none": readonly [
      "translate",
      "translate-x",
      "translate-y",
      "translate-z"
...
declare const extendTailwindMerge: <
...
declare const mergeConfigs: <
  ...
  ThemeGroupIds extends string = never
>(
