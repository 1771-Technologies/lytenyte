...
async function detectOverflow$1(state, options) {
  ...
  const clippingClientRect = rectToClientRect(
    await platform$1.getClippingRect({
      element: (
        (_await$platform$isEle = await (platform$1.isElement == null
          ? void 0
  ...
  const offsetScale = (await (platform$1.isElement == null
    ? void 0
    : platform$1.isElement(offsetParent)))
  ...
  return {
    ...
    async fn(state) {
      ...
      const resetPlacement =
        ((_placementsThatFitOnE = placementsSortedByMostSpace.filter((d) =>
  ...
  return {
    ...
    async fn(state) {
      ...
      const nativeClientRects = Array.from(
        (await (platform$1.getClientRects == null
          ? void 0
