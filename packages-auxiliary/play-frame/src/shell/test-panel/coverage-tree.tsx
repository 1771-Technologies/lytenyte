...
import { ChevronRightIcon, ChevronDownIcon, FileIcon, ComponentInstanceIcon } from "@radix-ui/react-icons";
  ...
  return (
    <Flex direction="column">
      ...
      >
        ...
        <ComponentInstanceIcon style={{ flexShrink: 0, color: "var(--amber-9)" }} />
