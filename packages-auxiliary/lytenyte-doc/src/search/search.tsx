                  ...
                  <A.Positioner className="z-50 outline-none" align="start" alignOffset={-40}>
                    <A.Popup
                      className={cn(
                        ...
                        "scroll-pb-2 scroll-pt-2 overflow-y-auto overscroll-contain",
                    ...
                    >
                      ...
                      <A.List>
                        {(movie: Movie) => (
                          <A.Item
                            key={movie.id}
                            className="data-highlighted:relative data-highlighted:z-0 data-highlighted:text-gray-50 data-highlighted:before:absolute flex cursor-default select-none py-2 pl-4 pr-8 text-base leading-4 outline-none data-[highlighted]:before:inset-x-2 data-[highlighted]:before:inset-y-0 data-[highlighted]:before:z-[-1] data-[highlighted]:before:rounded data-[highlighted]:before:bg-gray-900"
                            value={movie}
                          >
