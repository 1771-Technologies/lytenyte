...
import { createGenerator, type DocEntry } from "./base";
import { renderMarkdownToHast, renderTypeToHast } from "./markdown";
import type { ParameterTag } from "./parse-tags";
import { parseTags } from "./parse-tags";
import type { BaseTypeTableProps, GenerateTypeTableOptions } from "./type-table";
...
export function remarkAutoTypeTable(
  ...
  return async (tree, file) => {
    ...
    visit(tree, "mdxJsxFlowElement", (node) => {
      ...
      async function run() {
        const output = await generator.generateTypeTable(props as BaseTypeTableProps, {
          ...generateOptions,
