...
!demo:Autosizing Api="./demos/column-autosizing_x"
...
### Including Header Text In Autosize
...
In the demo below, the **Crypto Currency Symbol Logo & Ticker Shorthand & Symbol Name** column
has a long header, so autosizing expands the column to fit the header.

!demo:Header Autosizing="./demos/column-autosizing-header_x"
