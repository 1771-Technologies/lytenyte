...
import { ColumnsIcon, DragDotsSmallIcon } from "@1771technologies/lytenyte-pro/icons";
...
export function PillManagerRow({
  ...
  return (
    <div
      className={tw(
        "bg-ln-gray-05 border-ln-gray-20 grid grid-cols-[42px_1fr] border-t md:grid-cols-[121px_1fr]",
      )}
    >
