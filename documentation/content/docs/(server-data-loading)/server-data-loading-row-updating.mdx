...
- `requestsForView`: returns [Data Request Objects](/docs/reference/row-data-source#datarequest) for the current view.
...
ds.refresh()
// Is equivalent to
ds.pushRequests(ds.requestsForView())
```
...
The exact implementation depends on the developer. In practice, you are more likely to
