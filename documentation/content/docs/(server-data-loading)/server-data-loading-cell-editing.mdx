...
The example below demonstrates this. You can edit any cell value; after committing the change, it won't
...
The example above isn't perfect. The main issue is that cell updates aren't reflected
