...
the `nullsFirst` option; other or custom options can follow a similar pattern:
...
The grid doesn't require you to use its model — you can supply a custom sort model to the data fetcher. The example
