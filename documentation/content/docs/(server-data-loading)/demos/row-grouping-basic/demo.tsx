...
import { GroupCellRenderer, SalaryRenderer, YearsOfExperienceRenderer } from "./components";
import { GroupPills } from "./ui";

const columns: Column<SalaryData>[] = [
  { id: "Age", type: "number", width: 100, widthFlex: 1, uiHints: { rowGroupable: true } },
  { id: "Gender", width: 120, widthFlex: 1, uiHints: { rowGroupable: true } },
  {
    id: "Education Level",
    name: "Education",
    width: 160,
