...
<TypeTable
  type={{
    EditRenderer: {
      description:
        "Defines the edit renderer for a column.\n\nCan be either:\n- A string key referencing a registered editor component\n- A function of type  [EditRendererFn](/docs/reference/cell-edit#editrendererfn)  for custom rendering logic",
