...
<AutoTypeTable path="./types.ts" name="ColumnPivotColumnItem" />
...
<AutoTypeTable path="./types.ts" name="ColumnPivotModel" />
...
<AutoTypeTable path="./types.ts" name="ColumnPivotRowItem" />
...
<AutoTypeTable path="./types.ts" name="ColumnPivotValueItem" />
