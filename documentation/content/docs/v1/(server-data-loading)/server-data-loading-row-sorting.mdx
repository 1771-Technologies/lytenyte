...
The LyteNyte Grid [state object](/docs/v1/grid-reactivity) maintains a [sort model](/docs/v1/reference/sort#sortmodelitem),
...
- [Server Row Filtering](/docs/v1/server-data-loading-row-filtering): Server-side filtering, including **in filters (tree set filters)** and **quick search filters**.
- [Server Row Pinning](/docs/v1/server-data-loading-row-pinning): Pin rows to keep specific data visible.
