...
interface, see the [Data Interface guide](/docs/v1/server-data-loading-interface).
...
listed [here](https://clickhouse.com/docs/v1/sql-reference/aggregate-functions/reference).
...
- [Data Pushing or Pulling](/docs/v1/server-data-loading-push-and-pull): Manually request or push data to the server data source from the client.
