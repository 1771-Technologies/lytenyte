...
see the [Data Interface guide](/docs/v1/server-data-loading-interface) for more details.
...
See the [Data Interface guide](/docs/v1/server-data-loading-interface) for more information.
