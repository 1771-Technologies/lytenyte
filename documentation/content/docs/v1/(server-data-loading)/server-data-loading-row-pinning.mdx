...
the [Data Interface guide](/docs/v1/server-data-loading-interface) and
the [API reference](/docs/v1/reference/row-data-source#dataresponsepinned).
...
For more information, see the [Data Pushing and Pulling guide](/docs/v1/server-data-loading-push-and-pull).
