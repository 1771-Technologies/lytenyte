...
[Data Interface guide](/docs/v1/server-data-loading-interface).
...
```ts
// Columns defined on the server — excluding unrelated properties
...
See the [Cell Rendering guide](/docs/v1/cell-custom-renderers) for
...
See the [Handling Load Failures guide](/docs/v1/server-data-loading-handling-load-failures)
...
- [Server Row Sorting](/docs/v1/server-data-loading-row-sorting): Explains server-side sorting and client-side display.
- [Server Row Filtering](/docs/v1/server-data-loading-row-filtering): Covers server-side filtering, including **in filters (tree set filters)** and **quick search filters**.
- [Server Row Grouping and Aggregation](/docs/v1/server-data-loading-row-grouping-and-aggregation): Handles grouped data and loads group slices.
- [Handling Load Failures](/docs/v1/server-data-loading-handling-load-failures): Explores all scenarios where data requests may fail.
