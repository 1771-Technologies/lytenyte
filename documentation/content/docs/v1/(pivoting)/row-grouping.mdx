---
title: Row Grouping
description: Group rows by one or more columns in LyteNyte Grid and customize display and behavior for
...
group rows, see the [Row Aggregation guide](/docs/v1/row-aggregations).
