...
description: Use row aggregations in LyteNyte Grid to calculate and display summary data for grouped rows with
...
- [Client row data source](/docs/v1/row-client-data-source) - Calculates aggregations in the browser.
- [Server row data source](/docs/v1/row-server-data-source) - Calculates aggregations on the server.
