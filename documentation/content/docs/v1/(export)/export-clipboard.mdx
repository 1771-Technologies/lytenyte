---
title: Clipboard
description: Use LyteNyte Grid's clipboard API methods to implement copy, cut, and paste with customizable
  transform options.
---
...
[cell selection](/docs/v1/cell-selection) to support familiar spreadsheet-style interactions.
...
- **Cut** - Call `api.exportDataRect` to get the selected data, write it to the clipboard, then call
  ...
  **Note:** `api.editUpdate` requires the cells to be editable. See the [cell editing](/docs/v1/cell-editing)
  guide for details.
