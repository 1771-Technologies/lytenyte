...
<AutoTypeTable path="./types.ts" name="GridView" />
...
<AutoTypeTable path="./types.ts" name="HeaderCellFloating" />
...
<AutoTypeTable path="./types.ts" name="HeaderCellLayout" />
...
<AutoTypeTable path="./types.ts" name="HeaderGroupCellLayout" />
...
<AutoTypeTable path="./types.ts" name="HeaderLayout" />
...
<TypeTable
  type={{
    HeaderLayoutCell: {
      ...
      type: "HeaderCellLayout | HeaderCellFloating | HeaderGroupCellLayout",
    },
  }}
/>
...
<AutoTypeTable path="./types.ts" name="RowCellLayout" />
...
<AutoTypeTable path="./types.ts" name="RowFullWidthRowLayout" />
...
<TypeTable
  type={{
    RowLayout: {
      ...
      type: "RowNormalRowLayout | RowFullWidthRowLayout",
    },
  }}
/>
...
<AutoTypeTable path="./types.ts" name="RowNormalRowLayout" />
...
<AutoTypeTable path="./types.ts" name="RowSectionLayouts" />
...
<AutoTypeTable path="./types.ts" name="ViewBounds" />
