...
Parameters passed to the [AutosizeCellFn](/docs/v1/reference/column#autosizecellfn) function.
...
<AutoTypeTable path="./types.ts" name="AutosizeCellParams" />
...
Parameters passed to the [AutosizeHeaderFn](/docs/v1/reference/column#autosizeheaderfn) function.

These are used by LyteNyte Grid to calculate the ideal column width based on the
header content.

<AutoTypeTable path="./types.ts" name="AutosizeHeaderParams" />
...
<AutoTypeTable path="./types.ts" name="Column" />
...
<AutoTypeTable path="./types.ts" name="ColumnBase" />
...
<AutoTypeTable path="./types.ts" name="ColumnMarker" />
...
<AutoTypeTable path="./types.ts" name="ColumnMeta" />
...
<AutoTypeTable path="./types.ts" name="ColumnPivotUIHints" />
...
Includes support for pivot-specific behaviors via [ColumnPivotUIHints](/docs/v1/reference/column#columnpivotuihints) .

<AutoTypeTable path="./types.ts" name="ColumnUIHints" />
...
<AutoTypeTable path="./types.ts" name="RowGroupColumn" />
