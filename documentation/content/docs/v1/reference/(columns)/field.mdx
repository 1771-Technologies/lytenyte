...
<TypeTable
  type={{
    Field: {
      ...
      type: "number | string | FieldPath | FieldFn",
    },
  }}
/>
...
<TypeTable
  type={{
    FieldDataParam: {
      ...
      type: '{ data: T | null; kind: "\\"leaf\\"" } | { data: Record; key: string | null; kind: "\\"branch\\"" }',
    },
  }}
/>
...
<AutoTypeTable path="./types.ts" name="FieldFnParams" />
...
<AutoTypeTable path="./types.ts" name="FieldPath" />
...
<TypeTable
  type={{
    FieldRowGroup: {
      ...
      type: "number | string | FieldPath | FieldRowGroupFn",
    },
  }}
/>
...
<AutoTypeTable path="./types.ts" name="FieldRowGroupParamsFn" />
