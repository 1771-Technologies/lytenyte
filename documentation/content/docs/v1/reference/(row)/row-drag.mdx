...
<AutoTypeTable path="./types.ts" name="DragData" />
...
<AutoTypeTable path="./types.ts" name="DragEventParams" />
...
<AutoTypeTable path="./types.ts" name="DragMoveState" />
...
<AutoTypeTable path="./types.ts" name="DragPlaceholderParams" />
...
<AutoTypeTable path="./types.ts" name="DragPosition" />
...
<AutoTypeTable path="./types.ts" name="DropEventParams" />
...
<AutoTypeTable path="./types.ts" name="GetDragDataParams" />
...
<AutoTypeTable path="./types.ts" name="UseRowDragParams" />
