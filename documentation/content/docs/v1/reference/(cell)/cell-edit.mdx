...
- ''true'' for globally editable columns or [EditableFn](/docs/v1/reference/cell-edit#editablefn) for row-specific logic.
  \*/
...
Parameters passed to [EditableFn](/docs/v1/reference/cell-edit#editablefn) , the predicate function used to determine
...
<AutoTypeTable path="./types.ts" name="EditableFnParams" />
...
<AutoTypeTable path="./types.ts" name="EditActivePosition" />
...
<AutoTypeTable path="./types.ts" name="EditBeginParams" />
...
<TypeTable
  type={{
    EditRenderer: {
      description:
        "Defines the edit renderer for a column.\n\nCan be either:\n- A string key referencing a registered editor component\n- A function of type  [EditRendererFn](/docs/v1/reference/cell-edit#editrendererfn)  for custom rendering logic",
      type: "string | EditRendererFn",
    },
  }}
/>
...
Input parameters for the [EditRendererFn](/docs/v1/reference/cell-edit#editrendererfn) , used to render the edit UI for a cell.
...
<AutoTypeTable path="./types.ts" name="EditRendererFnParams" />
...
Input arguments passed to [EditRowValidatorFn](/docs/v1/reference/cell-edit#editrowvalidatorfn) .

Used to perform validation on the entire row during or after edit submission.

<AutoTypeTable path="./types.ts" name="EditRowValidatorFnParams" />
...
Input parameters passed to an [EditSetterFn](/docs/v1/reference/cell-edit#editsetterfn) .

Provides the context needed to compute and apply new row data based on edit input.

<AutoTypeTable path="./types.ts" name="EditSetterParams" />
...
<AutoTypeTable path="./types.ts" name="EditUpdateParams" />
