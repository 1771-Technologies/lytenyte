...
behavior uses the [`grid.api.rowSelectAll`](/docs/v1/reference/grid-api#gridapi) method. You can call
...
For more information about grid events, see the [Grid Events guide](/docs/v1/grid-events).
