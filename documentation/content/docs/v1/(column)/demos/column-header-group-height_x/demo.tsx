...
export default function ColumnBase() {
  ...
  useEffect(() => {
    if (height === "small") grid.state.headerGroupHeight.set(24);
    if (height === "medium") grid.state.headerGroupHeight.set(40);
    if (height === "large") grid.state.headerGroupHeight.set(60);
  }, [grid.state.headerGroupHeight, height]);
