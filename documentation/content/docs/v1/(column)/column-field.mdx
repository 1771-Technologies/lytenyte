...
[base column specification](/docs/v1/column-base).
...
See the [field data param](/docs/v1/reference/field#fielddataparam) for the exact type.
...
The `path` syntax matches [Lodash's `get`](https://lodash.com/docs/v1/#get) function. Examples:
