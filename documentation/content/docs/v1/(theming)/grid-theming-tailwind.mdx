...
We highly recommend reading the general [Grid Theming guide](/docs/v1/grid-theming) first to
...
See Tailwind's [Installation guide](https://tailwindcss.com/docs/v1/installation/using-vite) for framework-specific details.
...
The [Grid Theming guide](/docs/v1/grid-theming) explains that some elements
...
[arbitrary variants](https://tailwindcss.com/docs/v1/hover-focus-and-other-states#using-arbitrary-variants).
...
- [Installation With Shadcn](/docs/v1/intro-installation-shadcn): Learn how to use LyteNyte Grid with shadcn/ui.
- [Grid Theming](/docs/v1/grid-theming): Review the general theming guide to learn more about styling LyteNyte Grid.
- [Columns](/docs/v1/columns): See how column configuration affects what the grid displays.
- [Cell Renderers](/docs/v1/cell-custom-renderers): Define custom cell renderers for more control over cell content.
