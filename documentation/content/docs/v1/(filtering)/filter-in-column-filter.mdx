...
description: Use in-filters (set filters or tree-set filters) in LyteNyte Grid to filter data by selecting
...
[standard column filters](/docs/v1/filter-column-filters).
...
LyteNyte Grid PRO includes the [Tree Filter](/docs/v1/component-filter-tree) component, which lets you
