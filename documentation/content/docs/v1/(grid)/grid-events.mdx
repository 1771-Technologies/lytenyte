...
For more information, refer to the Events [API reference](/docs/v1/reference/events)
...
If you review the list of events in the [API Reference](/docs/v1/reference/events),
