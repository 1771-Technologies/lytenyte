...
[Sized Container guide](/docs/v1/grid-container).
...
[GitHub example](<https://github.com/1771-Technologies/lytenyte/blob/main/documentation/content/docs/v1/(introduction)/demos/getting-started/data.ts>).
...
`RowsBottom` for pinned rows. See the [Row Pinning guide](/docs/v1/row-pinning)
for details.
...
This cycles through ascending → descending → none. It also supports custom
...
[GitHub components file](<https://github.com/1771-Technologies/lytenyte/blob/main/documentation/content/docs/v1/(introduction)/demos/getting-started/components.tsx>)
for more renderers.
...
- [Row Data Sources](/docs/v1/row-data-source-intro): Create and use various row
  data sources.
- [Column Definitions](/docs/v1/columns): Review all column configuration options.
- [Grid Atoms & Reactivity](/docs/v1/grid-reactivity): Learn how LyteNyte Grid enables
  declarative reactivity.
- [API Reference](/docs/v1/reference): Browse all exported interfaces and types.
