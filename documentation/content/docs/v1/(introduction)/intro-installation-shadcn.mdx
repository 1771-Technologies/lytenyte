...
Follow the [shadcn/ui installation guide](https://ui.shadcn.com/docs/v1/installation) for your framework
to get started.
...
import type { Grid as G, RowLayout, RowNormalRowLayout } from "@1771technologies/lytenyte-pro/types";
                ...
                <Grid.HeaderRow headerRowIndex={i} key={i}>
                  {headerRow.map((headerCell) => {
                    if (headerCell.kind === "group")
                      return <Grid.HeaderGroupCell cell={headerCell} key={headerCell.idOccurrence} />;
...
import type { Grid as G, RowLayout, RowNormalRowLayout } from "@1771technologies/lytenyte-core/types";
