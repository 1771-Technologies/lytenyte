...
[Sized Container guide](<../(grid)/grid-container>).
...
[GitHub example](https://github.com/1771-Technologies/1771-website-demos/blob/main/intro/getting-started/src/data.ts).
...
`RowsBottom` for pinned rows. See the [Row Pinning guide](<../(row)/row-pinning>)
for details.
...
[GitHub components file](https://github.com/1771-Technologies/1771-website-demos/blob/main/intro/getting-started/src/components.tsx)
for more renderers.
...
- [Grid Reactivity](/docs/grid-reactivity): Learn how LyteNyte Grid enables
  declarative reactivity.
- [API Reference](/docs/reference/overview): Browse all exported interfaces and
  types.
