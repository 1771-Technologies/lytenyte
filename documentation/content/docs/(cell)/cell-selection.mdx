...
!demo:Range Cell Selection="./demo/cell-selection"
...
import CellSelectionMultiRange from "./demo/cell-selection-multi-range/demo";

!demo:Multi Range Cell Selection="./demo/cell-selection-multi-range"
