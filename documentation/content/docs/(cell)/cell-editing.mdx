...
title: Cell Editing
description:
  Enable and configure editable cells in LyteNyte Grid with custom editors, value parsing, and
...
!demo:Cell Edit Predicate="./demo/cell-editing"
...
!demo:Cell Edit Renderers="./demo/cell-editing-provider"
...
!demo:Cell Editing Selectively="./demo/cell-editing-selectively"

## Edit Setter

Use `editSetter` to control how updated values are written to row data. This is useful when a cell's
value comes from a derived or nested field. The [field](/docs/column-field) property determines the
displayed value.
...
!demo:Cell Editing Edit Setter="./demo/cell-editing-edit-setter"
...
!demo:Cell Editing Validation="./demo/cell-editing-validation"
